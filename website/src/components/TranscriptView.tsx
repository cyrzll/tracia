  ...
  if (!transcript || !khsHeader) {
    return (
      <Card className="shadow-sm border border-zinc-200 bg-white p-6 text-center">
        <p className="text-zinc-500 text-xs">Data nilai akademis tidak tersedia.</p>
      </Card>
    );
  }
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
      ...
      <div className="md:col-span-2 space-y-4">
        <div className="border-b border-zinc-200 pb-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            <h2 className="text-sm font-bold text-zinc-900 uppercase tracking-wide">Transkrip Nilai Akademik</h2>
            <p className="text-xs text-zinc-500 mt-1">Daftar nilai seluruh mata kuliah yang telah ditempuh.</p>
          </div>
            ...
            <Table>
              <TableHeader className="sticky top-0 bg-zinc-50 z-10 border-b border-zinc-200">
                <TableRow className="hover:bg-transparent border-b border-zinc-200">
                  ...
                  <TableHead className="text-zinc-500 py-2.5">Nama Mata Kuliah</TableHead>
                  <TableHead className="text-center text-zinc-500 py-2.5">SKS</TableHead>
                  <TableHead className="text-center text-zinc-500 py-2.5">Nilai</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {filtered.length > 0 ? (
      ...
      <div className="md:col-span-1 space-y-4">
        <div className="border-b border-zinc-200 pb-3">
          <h2 className="text-sm font-bold text-zinc-900 uppercase tracking-wide">Ringkasan Prestasi</h2>
          <p className="text-xs text-zinc-500 mt-1">Metrik performa akademik keseluruhan.</p>
        </div>
        ...
        <Card className="shadow-sm border border-zinc-200 bg-white">
          <CardContent className="p-6 space-y-6">
            ...
            <div className="text-center py-2">
              <span className="block text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Indeks Prestasi Kumulatif (IPK)</span>
            ...
            <div className="border-t border-zinc-100 pt-4 flex justify-between items-center text-xs">
              <span className="text-zinc-500 font-medium">Total SKS Diambil</span>
              <span className="font-mono font-bold text-zinc-900 bg-zinc-50 border border-zinc-200 px-2 py-0.5 rounded">
                {khsHeader.total_sks} SKS
              </span>
            </div>

            {/* Grade Distribution */}
            <div className="border-t border-zinc-100 pt-4 space-y-3">
              <span className="block text-[9px] font-bold text-zinc-400 uppercase tracking-wider">Distribusi Nilai</span>
